...
public class ItemModel {
    ...
    public void setAvailability_id(int availability) {
        this.availability = availability;
    }

    public ItemModel(String dish_name, String dish_description, String dish_price, int img_id,int availability) {
        this.dish_name = dish_name;
        this.dish_description= dish_description;
        this.dish_price= dish_price;
        this.img_id = img_id;
