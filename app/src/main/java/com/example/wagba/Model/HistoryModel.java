...
public class HistoryModel {
    ...
    public HistoryModel(String order_name, String order_date, String order_price, String order_status, int restaurant_img_id, int food_type_img_id, String order_item_1, String order_item_2, String order_item_3, String order_item_1_price, String order_item_2_price, String order_item_3_price, String total_price_details) {
        this.order_name = order_name;
        this.order_date= order_date;
        this.order_price= order_price;
        this.order_status = order_status;
